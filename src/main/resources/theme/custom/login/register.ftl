<#import "template.ftl" as layout><@layout.registrationLayout displayInfo=social.displayInfo displayWide=false; section><#if section == "header">
Register
<#elseif section == "form">
<div id="kc-form">
	<div id="kc-form-wrapper">
		<form id="kc-register-form" onsubmit="register.disabled = true; return validateForm();" action="/realms/master/custom-registration/register" method="post">
			...
			<div class="form-group">
				...
				<!-- Sector Field -->
				<div class="form-group">
                    <label for="sector" class="${properties.kcLabelClass!}">Sector:</label>
                    <select id="sector" name="sector" class="${properties.kcInputClass!}">
                        <option value="">None</option>
                        <option value="ecommerce">E-commerce</option>
                        <option value="retail">Retail</option>
                        <option value="it">IT</option>
                        <option value="tourism_services">Tourism Services</option>
                        <option value="hospitality_and_accommodation">Hospitality and Accommodation</option>
                        <option value="travel_and_transportation">Travel and Transportation</option>
...
</script>undefined</@layout.registrationLayout>