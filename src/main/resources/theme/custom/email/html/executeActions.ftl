...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>You have been added to the team at <strong><#if user.attributes.companyName?? && user.attributes.companyName??>${user.attributes.companyName}<#else>Convonest</#if></strong>. To access your account, please verify your email and set your password.</p>
            <a href="${link}" class="verify-button">Verify and Set Password</a>
        ...
        <div class="footer">
            ...
            <p><a href="https://convonest.com">Visit our website</a></p>
        </div>
    </div>
</body>
</html>